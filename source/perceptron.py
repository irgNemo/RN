...
def main():
	...
	#instancias = cargarBase.leerArchivo("./basesDatos/wine.data",",",1,{"1":[1,-1,-1],"2":[-1,1,-1],"3":[-1,-1,1]})
	...
	rangosInicializacionPesos = "[1,1][-0.0005,0.0005][-0.5,0.5]" 
	...
	crossValidation = CrossValidation(redNeuronal, kfold, repeticionesKfold, instancias)
